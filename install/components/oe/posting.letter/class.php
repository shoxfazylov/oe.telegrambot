...
class PostingLetterComponent extends CBitrixComponent
{
	...
	protected function initParams()
	{
		...
		$this->arResult['PATH_TO_USER_PROFILE'] = isset($this->arParams['PATH_TO_USER_PROFILE']) ? $this->arParams['PATH_TO_USER_PROFILE'] : '/bitrix/admin/user_edit.php?lang=ru&ID=#id#';
	...
	public function executeComponent()
	{
		...
		if (!Bitrix\Main\Loader::includeModule('oe.telegrambot'))
		{
			$this->errors->setError(new Error('Module `oe.telegrambot` is not installed.'));
			$this->printErrors();
			return;
		}
